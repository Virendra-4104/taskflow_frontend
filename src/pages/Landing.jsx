            ...
            <section className='relative overflow-hidden mt-30 '>
                <div className='max-w-6xl mx-auto px-6 relative grid lg:grid-cols-2 items-center border-b border-mute-text/40 pb-20'>
                    <div className='flex flex-col'>
                        ...
                        <h1 className='text-primary-text text-5xl font-bold my-4 sm:text-5xl'>Work, in motion.</h1>
                        ...
                        <div className='flex gap-5 items-center'>
                            <Link to="/login" className='flex justify-center items-center gap- text-base bg-primary-button border text-background px-5 py-2 rounded-xl font-medium cursor-pointer hover:bg-hover-button'>Get started free <ArrowRight /></Link>
                            <Link to="/register" className='text-primary-text px-5 py-2 rounded-xl font-medium cursor-pointer bg-secondary-background hover:border border-success'>Sign in</Link>
                        </div>
                    </div>

                    <div className='text-primary-text flex justify-center items-center pl-8 pt-10 lg:pl-8'>
                        <div className='flex flex-col w-fit max-w-3xl bg-secondary-background/60 p-4 gap-5 rounded-2xl h-fit'>
                            ...
                            <div className='flex flex-col gap-3 sm:flex-row sm:flex-wrap'>
                                {
                                    stages.map((stage, index) => (
                                        <div className='w-full sm:w-[48%] lg:w-[31%] p-2 border border-ink-700 min-h-33 rounded-xl'>
                                            <div>
            ...
            <section className='max-w-6xl mx-auto px-6 pb-24 pt-20'>
                <div className="bg-ink-900 border border-ink-700 rounded-xl shadow-card relative overflow-hidden px-8 py-14 text-center">
                    ...
                    <div className="relative flex justify-center flex-col items-center">
                        ...
                        <Link to="/login" className="bg-primary-button flex gap-2 justify-center items-center mt-7 px-3 py-3 rounded-xl cursor-pointer">
